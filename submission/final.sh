...
COLLECTED=$(echo "$NEW_BALANCE - 0" | bc)
...
# WRITE YOUR SOLUTION BELOW:
P2SH_VALID=$(bitcoin-cli -regtest validateaddress "$P2SH_ADDR" | jq '.isvalid')
